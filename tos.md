rebloxed Launcher: Terms of Service
...
Open Source: The source code for this launcher is publicly available. Users are encouraged to audit the code to verify how their data is handled.
...
Use the tool for automated "botting," unauthorized account access, or any malicious activity.
...
Loss of data or account access resulting from improper handling of session cookies by the user.
